...
//   return (
//     <div
//       className={cn("fixed bottom-8 right-8 z-50 block md:hidden", className)}
//     >
//       <AnimatePresence>
//         {open && (
//           <motion.div
...
//                   whileTap={{ scale: 0.95 }}
//                 >
//                   <motion.div className="h-4 w-4" whileHover={{ scale: 1.1 }}>
//                     {item.icon}
//                   </motion.div>
//                 </motion.a>
//               </motion.div>
...
const FloatingDockDesktop = ({
  ...
  return (
    <motion.div
      ...
      onMouseLeave={() => mouseX.set(Infinity)}
      className={cn(
        "mx-auto hidden h-16 items-end gap-4 rounded-2xl bg-background border border-border px-4 pb-3 md:flex",
        className,
      )}
    >
      {items.map((item) => (
